...
| 10 | 2026-08-13 ~07:00 ET | Prod matrix v2 after phase-2 deploy: reddit rescue, X, pinterest, FB video, FB photo, tiktok (1-session policy-cache proof) | web_scraper + browser_api | various | reddit rescue $0.0015 (yh1Fg); X/pinterest/FB-video/FB-photo native $0; tiktok 1 session $0.0309 (policy-cache proven in prod) | $0.0324 actual | ~$0.23 |
