...
| 10 | 2026-08-13 ~07:00 ET | Prod matrix v2 after phase-2 deploy: reddit rescue, X, pinterest, FB video, FB photo, tiktok (1-session policy-cache proof) | web_scraper + browser_api | various | (post-run) | est ~$0.035 | tbd |
